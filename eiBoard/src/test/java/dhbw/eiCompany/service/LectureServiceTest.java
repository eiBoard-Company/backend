...
public class LectureServiceTest {
    ...
    void getDay() throws MalformedURLException, IllegalAccessException, NoConnectionException {
        // Arrange
        LocalDate date = LocalDate.of(2023, Month.JUNE, 1);
        Map<LocalDate, ArrayList<Appointment>> data = new HashMap<>();
        Appointment appointment = new Appointment(LocalDateTime.of(2023, Month.JUNE, 1, 9, 0),
                LocalDateTime.of(2023, Month.JUNE, 1, 11, 0),
                "Compilerbau", "Eisenbiegler, Jörn", "F492  Hörsaal,TINF21B4");
        ...
        Assertions.assertEquals("Eisenbiegler, Jörn", lecture.getLecturer());
        Assertions.assertEquals("F492  Hörsaal,TINF21B4", lecture.getRoom());
        Assertions.assertEquals("Compilerbau", lecture.getLecture());
        Assertions.assertEquals(LocalDateTime.of(2023, Month.JUNE, 1, 9, 0), lecture.getStart());
        Assertions.assertEquals(LocalDateTime.of(2023, Month.JUNE, 1, 12, 15), lecture.getEnd());
        Assertions.assertEquals(LocalDate.of(2023, Month.JUNE, 1), lecture.getDate());
    }
    ...
    void getWeek() throws MalformedURLException, IllegalAccessException, NoConnectionException {
        ...
        Map<LocalDate, ArrayList<Appointment>> data = new HashMap<>();
        Appointment appointment1 = new Appointment(LocalDateTime.of(2023, Month.JUNE, 1, 9, 0),
                LocalDateTime.of(2023, Month.JUNE, 1, 11, 0),
                "Mathematics", "Eisenbiegler, Jörn", "F492  Hörsaal,TINF21B4");
        Appointment appointment2 = new Appointment(LocalDateTime.of(2023, Month.JUNE, 3, 10, 0),
                LocalDateTime.of(2023, Month.JUNE, 3, 12, 0),
                "Physics", "Jane Smith", "Room B");
        ...
        Assertions.assertEquals(10, scheduleDay1.getLectureList().size());
        ...
        Assertions.assertEquals("Pfingstmontag", lecture1.getLecture());
        Assertions.assertEquals(LocalDateTime.of(2023, Month.MAY, 29, 8, 0), lecture1.getStart());
        Assertions.assertEquals(LocalDateTime.of(2023, Month.MAY, 29, 18, 0), lecture1.getEnd());
        Assertions.assertEquals(LocalDate.of(2023, Month.MAY, 29), lecture1.getDate());
